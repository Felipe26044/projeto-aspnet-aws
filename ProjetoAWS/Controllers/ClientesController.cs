...
namespace ProjetoAWS.Controllers
{
    ...
    public class ClientesController : ControllerBase
    {
        ...
        public ClientesController(IConfiguration configuration)
        {
            ...
            ("Connection string 'BDClientes' não encontrada.");
        }
        ...
        public ActionResult<Cliente> Post([FromBody] Cliente cliente)
        {
            ...
            command.Parameters.Add("@Nome", SqlDbType.VarChar, 150)
        .Value = cliente.Nome;
            command.Parameters.Add("@Email", SqlDbType.VarChar, 150)
        .Value = cliente.Email;
            command.Parameters.Add("@Telefone", SqlDbType.VarChar, 30)
        ...
        [HttpPut("{id:int}")]
        public ActionResult<Cliente> Put(int id,
        ...
        .Value = clienteAtualizado.Email;
            command.Parameters.Add("@Telefone", SqlDbType.VarChar, 30)
        .Value = clienteAtualizado.Telefone;
            command.Parameters.Add("@Cpf", SqlDbType.VarChar, 20)
        .Value = clienteAtualizado.Cpf;
